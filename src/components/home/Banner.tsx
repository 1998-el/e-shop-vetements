    ...
    <>
      ...
      <div className="lg:hidden relative h-[400px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-6 text-center">
          <h1 className="text-3xl font-bold mb-4 leading-tight text-white drop-shadow">
            Un repas prêt en 10 minutes
            <br />
            <span className="text-white">sans corvée d'épluchage</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-8 py-16">
          <div className="grid grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl font-bold mb-6 leading-tight text-helloboku-headings">
                Un repas prêt en 10 minutes
                <br />
                <span className="text-helloboku-links">sans corvée d'épluchage</span>
              </h1>
